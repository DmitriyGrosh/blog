...
### Я хочу видеть свой компонет примерно в таком виде
```tsx
...
И тут на ум сразу приходит на ум HOC connect из react-redux. Там тоже можно прокидывать два типа пропсов,
...
Если кратко, то у нас есть HOC, который принимает дефолтные пропсы и компонет. Сначала он будет получать пропсы тип TInjected,
